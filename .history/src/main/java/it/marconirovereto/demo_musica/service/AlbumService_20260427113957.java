...
/* Dichiarazione dei services per Album:
   ...
   Nota: dal punto di vista della scalabilità si può optare per un'Interface l'implementazione della quale si potrebbe collocare in un sub-package è nel subpackage impl
*/
